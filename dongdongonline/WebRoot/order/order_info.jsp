	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<!-- 订单开始 -->
					<tr>
						...
						<td valign="top">
							<s:property value="value.book.dang_price"/>
						</td>
						<td valign="top">
							<s:property value="value.buycount"/>
						</td>
						<td valign="top">
							<s:property value="value.buycount*value.book.dang_price"/>
						</td>
					</tr>
				</s:iterator>
				<!-- 	<tr>
			...
			<div class="login_in">
				...
				<a href="<s:url action="address_selectAlladdress" namespace="/address"/>"><input id="btnClientRegister" class="button_1" name="submit"
